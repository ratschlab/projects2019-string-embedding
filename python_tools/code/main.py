...
def get_bsub_cmd(job, options, mem = -1, t = -1):
    ...
    for k,v in options.__dict__.items():
        if k not in ['target', 'seq_id', 'search_seq_id', 'target', 'forward_target', 'memory', 'time', 'verbose']:
...
if __name__ == '__main__':
    ...
    parser.add_option('-v','--verbose',dest='verbose', default = 2, type='int', help = ' level of verbosity ')

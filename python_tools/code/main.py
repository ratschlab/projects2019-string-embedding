...
def load_paths(file_name, folder = 'experimental'):
    data_path = PROJ_DIR + '/data/' + file_name + '.npz'
    result_path = PROJ_DIR + '/results/' + folder +  '/' + file_name +'/'  
...
def get_job_from_target(target, i, j):
    if target in ['clean', 'merge', 'final']:
        job = (target,)
...
if __name__ == '__main__':
    ...
    parser.add_option('-d','--directory',dest='directory', default = 'experimental', type='str', help = ' directory for results ')
    ...
    if options.target=='all':
        ...
        print('analysis options : ', options)
